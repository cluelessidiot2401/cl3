...
class Philosopher(threading.Thread):
    ...
    def run(self):
        while(self.running):
            ...
            print('%s needs resources.' % self.name)
            self.dine()
    ...
    def dine(self):
        ...
        while self.running:
            ...
            if locked: break
            fork1.release()
            print('%s swaps resources' % self.name)
    ...
    def dining(self):			
        print('%s starts executing '% self.name)
...
def DiningPhilosophers():
    ...
    philosopherNames = ('Firefox','Chrome','DropBox','Eclipse', 'AndroidStudio')
